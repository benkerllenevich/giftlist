<div>
    <x-button wire:click="startCreatingCategory" wire:loading.attr="disabled">
        New Category
    </x-button>

    <x-dialog-modal wire:model.live="creatingCategory">
        <x-slot name="title">
            {{ __('Create New Category') }}
        </x-slot>

        <x-slot name="content">
            {{ __('Please enter the name of the category you would like to create.') }}
