<div class="bg-white py-5 px-7 rounded-md border border-gray-200 flex justify-between items-center">
    <span>{{ $category->name }}</span>

    <div>
        <button aria-label="{{ $category->name }} settings"
                wire:click="openSettings"
                class="flex border-2 border-transparent rounded-md focus:outline-none focus:border-gray-200 transition">
